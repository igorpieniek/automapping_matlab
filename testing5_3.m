...
RealMap = 'mapa_paint9.png';     % Wczytywana rzeczywista mapa 
MapResolution = 40;              % Rozdzielczoœæ mapy - iloœæ pikseli przypadaj¹ca na metr  
startPoint = [0.5 .5 pi/2];      % Punkt startowy robota oraz jego pocz¹tkowe po³o¿enie k¹towe [x y rad]
...
% Wyniki
show_child_points = false;       % Aktualne przedstawienie wszystkich punktów rozgalezien
